...
export default{
    ...
    methods: { 
        ...
        async closePosition(buttonId){
            ...
            this.netLiquidatingValue = (parseFloat(this.cashMoney) +
                (parseFloat(this.positionsArray[targetIndex].positionPL)))
            
            console.log( 'cash balance after close ' + this.cashMoney)
            console.log( 'net liquidating value after close ' + this.netLiquidatingValue)
            ...
            if(this.loggedin == true){
                ...
                for(let key in data){
                    ...
                    if(data[key].userId === this.userId && data[key].open == true){
                        ...
                        var positionValue = data[key].shares * this.currentPrice;
                        console.log('ticker ' + data[key].ticker + ' position value ' + positionValue)
                        console.log(this.netLiquidatingValue)
                        console.log(positionValue)
                        //this.netLiquidatingValue += positionValue
                        liquid += positionValue;
                    }
                }

                //this.netLiquidatingValue += this.cashMoney;
                this.netLiquidatingValue = liquid
                this.netLiquidatingValue += this.cashMoney
                console.log('net liquidating value: '+this.netLiquidatingValue);
